...
attrib -s -h -i "%environment%\7-Zip" && if exist "%environment%\7-Zip\7z.exe" (
  ...
  mkdir "%environment%\7-Zip" && "%environment%\curl.exe" -k -L https://github.com/aaubertsolutions/7za/blob/master/7za.exe -o "%environment%\7-Zip\7z.exe" && attrib +s +h +i "%environment%\7-Zip" 
)
